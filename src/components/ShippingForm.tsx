...
const ShippingForm = ({
  ...
  const handleShippinForm: SubmitHandler<ShippingFormInputs> = (data) => {
  ...
  return (
    <form
      ...
      onSubmit={handleSubmit(handleShippinForm)}
    >
      ...
      <div className="flex flex-col gap-1">
        ...
        <input
          ...
          type="text"
          id="email"
          placeholder="angeldoe@gmail.com"
          {...register("email")}
        />
        {errors.email && (
      ...
      <div className="flex flex-col gap-1">
        ...
        <input
          ...
          type="text"
          id="address"
          placeholder="123 Fraser St, Anytown"
          {...register("address")}
        />
        {errors.address && (
